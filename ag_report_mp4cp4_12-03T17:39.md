...
Report generated at 2023-12-03T18:21:09-06:00, using commit ``da4614833c37e9aaa4883dfc4816a777ebd3f681``

Autograder Run ID: 002d4e43-9afd-43d2-b72e-8d60a63b8ba9

Autograder Job ID: 63043522-bcb2-417d-b002-96ca5b74d264
...
<details><summary>Compile ⚠️</summary> 
 ...
 ``` 
 mkdir -p sim
cd sim && vcs /tmp/dut/pkg/types.sv /tmp/dut/hdl/wb_stage.sv /tmp/dut/hdl/pipeline_registers.sv /tmp/dut/hdl/mp4datapath.sv /tmp/dut/hdl/mp4control.sv /tmp/dut/hdl/mp4.sv /tmp/dut/hdl/mem_stage.sv /tmp/dut/hdl/exe_stage.sv /tmp/dut/hdl/mem_interface/arbiter.sv /tmp/dut/hdl/mem_interface/mem_word_adaptor.sv /tmp/dut/hdl/mem_interface/cacheline_adaptor.sv /tmp/dut/hdl/mem_interface/cache/valid.sv /tmp/dut/hdl/mem_interface/cache/ff_array.sv /tmp/dut/hdl/mem_interface/cache/dirty.sv /tmp/dut/hdl/mem_interface/cache/cache_datapath.sv /tmp/dut/hdl/mem_interface/cache/cache_control.sv /tmp/dut/hdl/mem_interface/cache/cache.sv /tmp/dut/hdl/mem_interface/cache/PLRU.sv /tmp/dut/hdl/ctrl_buffer/prefetch_buffer.sv /tmp/dut/hdl/ctrl_buffer/control_buffer.sv /tmp/dut/hdl/shift_reg.sv /tmp/dut/hdl/sext_half.sv /tmp/dut/hdl/sext_byte.sv /tmp/dut/hdl/register.sv /tmp/dut/hdl/regfile.sv /tmp/dut/hdl/multiply_and_divide.sv /tmp/dut/hdl/multiplier_v2.sv /tmp/dut/hdl/multiplier.sv /tmp/dut/hdl/mem_data_out.sv /tmp/dut/hdl/mar.sv /tmp/dut/hdl/hazard_queue.sv /tmp/dut/hdl/fetch_stage.sv /tmp/dut/hdl/divider_slow.sv /tmp/dut/hdl/div_compare.sv /tmp/dut/hdl/decode_stage.sv /tmp/dut/hdl/counter.sv /tmp/dut/hdl/cmp.sv /tmp/dut/hdl/alu.sv /tmp/dut/hvl/top_tb.sv /tmp/dut/hvl/rvfimon.v /tmp/dut/hvl/monitor.sv /tmp/dut/hvl/mon_itf.sv /tmp/dut/hvl/burst_memory.sv /tmp/dut/hvl/bmem_itf.sv /tmp/dut/sram/output/mp3_tag_array/mp3_tag_array.v /tmp/dut/sram/output/mp3_data_array/mp3_data_array.v -full64 -lca -sverilog +lint=all,noNS -timescale=1ns/1ns -debug_acc+all -kdb -fsdb -suppress=LCA_FEATURES_ENABLED -licqueue -msg_config=../vcs_warn.config -l compile.log -top top_tb -o top_tb
                         Chronologic VCS (TM)
      Version R-2020.12-SP1-1_Full64 -- Sun Dec  3 18:22:42 2023
...
Warning:  /tmp/dut/synth/../hdl/pipeline_registers.sv:571: Nonstandard package access 'memfwdmux::'; this name has a more local definition. (VER-734)
Warning:  /tmp/dut/synth/../hdl/pipeline_registers.sv:572: Nonstandard package access 'memfwdmux::'; this name has a more local definition. (VER-734)
Warning:  /tmp/dut/synth/../hdl/pipeline_registers.sv:573: Nonstandard package access 'memfwdmux::'; this name has a more local definition. (VER-734)
Warning:  /tmp/dut/synth/../hdl/pipeline_registers.sv:628: Nonstandard package access 'memfwdmux::'; this name has a more local definition. (VER-734)
Presto compilation completed successfully.
Running PRESTO HDLC
...
Inferred memory devices in process
	in routine cache_arbiter line 101 in file
		'/tmp/dut/synth/../hdl/mem_interface/arbiter.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
|      state_reg      | Flip-flop |  30   |  Y  | Y  | N  | N  | N  | N  | N  |
...
Statistics for case statements in always block at line 73 in file
	'/tmp/dut/synth/../hdl/mem_interface/cache/cache_control.sv'
===============================================
|           Line           |  full/ parallel  |
===============================================
|            75            |    auto/auto     |
...
Inferred memory devices in process
	in routine cache_control line 52 in file
		'/tmp/dut/synth/../hdl/mem_interface/cache/cache_control.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Statistics for case statements in always block at line 155 in file
	'/tmp/dut/synth/../hdl/mem_interface/cache/cache_datapath.sv'
===============================================
|           Line           |  full/ parallel  |
===============================================
|           164            |    user/user     |
...
|  block name/line   | Inputs | Outputs | # sel inputs |
========================================================
| cache_datapath/206 |   4    |   23    |      2       |
| cache_datapath/210 |   4    |   256   |      2       |
========================================================
...
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
|  order_counter_reg  | Flip-flop |  64   |  Y  | Y  | N  | Y  | N  | N  | N  |
===============================================================================
...
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
|     cw_data_reg     | Flip-flop |  414  |  Y  | Y  | N  | N  | Y  | N  | N  |
...
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
|   prev_order_reg    | Flip-flop |  64   |  Y  | Y  | N  | N  | N  | Y  | N  |
===============================================================================
...
Inferred memory devices in process
	in routine exe_mem_reg line 264 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine exe_mem_reg line 274 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
|     cw_data_reg     | Flip-flop |  414  |  Y  | Y  | Y  | N  | N  | N  | N  |
|     cw_data_reg     | Flip-flop |   1   |  N  | Y  | N  | Y  | N  | N  | N  |
===============================================================================

Inferred memory devices in process
	in routine exe_mem_reg line 348 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine exe_mem_reg line 358 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine exe_mem_reg line 371 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine exe_mem_reg line 381 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine exe_mem_reg line 450 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Warning:  /tmp/dut/synth/../hdl/pipeline_registers.sv:570: Case statement marked unique does not cover all possible conditions. (VER-504)

Statistics for case statements in always block at line 516 in file
	'/tmp/dut/synth/../hdl/pipeline_registers.sv'
===============================================
|           Line           |  full/ parallel  |
===============================================
...
Statistics for case statements in always block at line 569 in file
	'/tmp/dut/synth/../hdl/pipeline_registers.sv'
===============================================
|           Line           |  full/ parallel  |
===============================================
...
Inferred memory devices in process
	in routine mem_wb_reg line 578 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine mem_wb_reg line 588 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine mem_wb_reg line 609 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine mem_wb_reg line 716 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine mem_wb_reg line 726 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine mem_wb_reg line 736 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Warning:  /tmp/dut/synth/../hdl/wb_stage.sv:116: Case statement marked unique does not cover all possible conditions. (VER-504)
...
Inferred memory devices in process
	in routine wb_stage line 36 in file
		'/tmp/dut/synth/../hdl/wb_stage.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Inferred memory devices in process
	in routine wb_fwd_reg line 758 in file
		'/tmp/dut/synth/../hdl/pipeline_registers.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Information: Building the design 'dirty' instantiated from design 'cache_datapath' with
...
Information: Building the design 'valid' instantiated from design 'cache_datapath' with
	the parameters "s_index=4,w_index=2". (HDL-193)
...
Information: Building the design 'PLRU_4_way' instantiated from design 'cache_datapath' with
...
Information: Building the design 'multiplier_v2'. (HDL-193)

Statistics for case statements in always block at line 148 in file
	'/tmp/dut/synth/../hdl/multiplier_v2.sv'
===============================================
|           Line           |  full/ parallel  |
===============================================
|           154            |    auto/auto     |
...
Inferred memory devices in process
	in routine multiplier_v2 line 148 in file
		'/tmp/dut/synth/../hdl/multiplier_v2.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
|   ult_result_reg    | Flip-flop | 1024  |  Y  | Y  | N  | N  | Y  | N  | N  |
|      count_reg      | Flip-flop |   4   |  Y  | Y  | N  | N  | Y  | N  | N  |
===============================================================================
Presto compilation completed successfully. (multiplier_v2)
...
link
  ...
  --------------------------------------------------------------------------
  * (40 designs)              /tmp/dut/synth/mp4.db, etc
...
Information: Uniquified 2 instances of design 'dirty_s_index4_w_index2'. (OPT-1056)
...
Information: Uniquified 16 instances of design 'ff_array_s_index4_width1'. (OPT-1056)
...
Information: Ungrouping 90 of 199 hierarchies before Pass 1 (OPT-775)
Information: State dependent leakage is now switched from on to off.

  Beginning Pass 1 Mapping
  ------------------------
  Processing 'multiplier_v2'
Information: Added key list 'DesignWare' to design 'multiplier_v2'. (DDB-72)
 Implement Synthetic for 'multiplier_v2'.
...
Information: Added key list 'DesignWare' to design 'exe_stage'. (DDB-72)
 Implement Synthetic for 'exe_stage'.
  ...
  Mapping integrated clock gating circuitry
  Processing 'SNPS_CLOCK_GATE_HIGH_multiplier_v2_0'
  Mapping integrated clock gating circuitry
...
Information: Performing clock-gating on design multiplier_v2. (PWR-730)
...
Information: Complementing port 'mem_resp' in design 'cache_1'.
	 The new name of the port is 'mem_resp_BAR'. (OPT-319)
Information: Complementing port 'plru_update' in design 'cache_datapath_1'.
	 The new name of the port is 'plru_update_BAR'. (OPT-319)
Information: Complementing port 'address[8]' in design 'cache_datapath_1'.
	 The new name of the port is 'address[8]_BAR'. (OPT-319)
Information: Complementing port 'mem_address[8]' in design 'cache_1'.
	 The new name of the port is 'mem_address[8]_BAR'. (OPT-319)
Information: Complementing port 'pmem_address[8]' in design 'cache_datapath_1'.
	 The new name of the port is 'pmem_address[8]_BAR'. (OPT-319)
Information: Complementing port 'pmem_address[8]' in design 'cache_1'.
	 The new name of the port is 'pmem_address[8]_BAR'. (OPT-319)
...
Information: Complementing port 'address[7]' in design 'cache_datapath_1'.
	 The new name of the port is 'address[7]_BAR'. (OPT-319)
Information: Complementing port 'mem_address[7]' in design 'cache_1'.
	 The new name of the port is 'mem_address[7]_BAR'. (OPT-319)
Information: Complementing port 'pmem_address[7]' in design 'cache_datapath_1'.
	 The new name of the port is 'pmem_address[7]_BAR'. (OPT-319)
Information: Complementing port 'pmem_address[7]' in design 'cache_1'.
	 The new name of the port is 'pmem_address[7]_BAR'. (OPT-319)
...
Information: Complementing port 'address[6]' in design 'cache_datapath_1'.
	 The new name of the port is 'address[6]_BAR'. (OPT-319)
Information: Complementing port 'mem_address[6]' in design 'cache_1'.
	 The new name of the port is 'mem_address[6]_BAR'. (OPT-319)
Information: Complementing port 'pmem_address[6]' in design 'cache_datapath_1'.
	 The new name of the port is 'pmem_address[6]_BAR'. (OPT-319)
Information: Complementing port 'pmem_address[6]' in design 'cache_1'.
	 The new name of the port is 'pmem_address[6]_BAR'. (OPT-319)
...
Information: Complementing port 'pmem_write' in design 'cache_1'.
	 The new name of the port is 'pmem_write_BAR'. (OPT-319)
Information: Complementing port 'dataout_sel_mux' in design 'cache_datapath_1'.
	 The new name of the port is 'dataout_sel_mux_BAR'. (OPT-319)
Information: Complementing port 'pmem_address_mux' in design 'cache_datapath_1'.
...
Information: Ungrouping hierarchy dcache0 'cache_1' #insts = 22. (OPT-777)
Information: Ungrouping hierarchy icache0 'cache_0' #insts = 24. (OPT-777)
Information: Ungrouping hierarchy dcache0/datapath 'cache_datapath_1' #insts = 2376. (OPT-777)
Information: Ungrouping hierarchy icache0/datapath 'cache_datapath_0' #insts = 1793. (OPT-777)
Information: Ungrouping hierarchy datapath/decode 'decode_stage' #insts = 0. (OPT-777)
Information: Ungrouping hierarchy datapath/execute 'exe_stage' #insts = 1026. (OPT-777)
Information: Ungrouping hierarchy datapath/execute/alu_logic/multi_div 'multiply_and_divide' #insts = 906. (OPT-777)
  ...
  --------- --------- --------- --------- --------- ------------------------- --------- -----------
    0:01:48  156906.2      0.00       0.0    5980.9                           2385010.7500      0.00  
    0:01:49  156668.2      0.00       0.0    6018.5                           2378818.7500      0.00  

  Beginning Constant Register Removal
  -----------------------------------
    0:01:52  156677.7      0.00       0.0    6018.5                           2379916.7500      0.00  
    0:01:53  156676.9      0.00       0.0    6018.5                           2379899.2500      0.00  
  ...
  ----------------------------
    0:02:06  131107.4      0.00       0.0    5124.3                           1042129.1250      0.00  
